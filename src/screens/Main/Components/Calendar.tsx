    ...
    return (
      <View style = {styles.sectionContainer}> 
        <View style= {[styles.titleContainer,styles.flexRow]}>
          <View style = {[styles.titleLabel,styles.flexCol]}><Text style={[styles.titleText]}>S</Text></View>
          <View style = {[styles.titleLabel,styles.flexCol]}><Text style={[styles.titleText]}>M</Text></View>
          <View style = {[styles.titleLabel,styles.flexCol]}><Text style={[styles.titleText]}>T</Text></View>
          <View style = {[styles.titleLabel,styles.flexCol]}><Text style={[styles.titleText]}>W</Text></View>
          <View style = {[styles.titleLabel,styles.flexCol]}><Text style={[styles.titleText]}>Th</Text></View>
          <View style = {[styles.titleLabel,styles.flexCol]}><Text style={[styles.titleText]}>F</Text></View>
          <View style = {[styles.titleLabel,styles.flexCol]}><Text style={[styles.titleText]}>S</Text></View>
        </View>
